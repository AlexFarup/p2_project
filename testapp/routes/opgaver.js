...
router.post('/sendA/:opgavenummer', function (req, res) {
 ...
 var hint_score = req.body.hint_score; 
 var hintpoint = req.body.hintpoint;
 var tid_score = 299;
  ...
  con.connect(function (err) {
      ...
      var sql = `UPDATE \`Besvarelser\` SET \`Besv_Score\` = ${score}, \`Besv_Svar\` = ${svar}, \`Besv_Besvaret\` = 1 WHERE \`Besvarelse_ID\` = ${opgavenummer}`;
      main();
