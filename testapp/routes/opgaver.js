...
router.post('/sendA/:opgavenummer', function (req, res) {
 ...
 var hint_point = req.body.hintpoint;
 var tid_score = 299;
  ...
  con.connect(function (err) {
      ...
      var sql = `UPDATE \`Besvarelser\` SET \`Besv_Score\` = ${score}, \`Besv_Svar\` = ${svar}, \`Besv_Besvaret\` = 1, \`Besv_Hint\` = ${hint_point} WHERE \`Besvarelse_ID\` = ${opgavenummer}`;
      main();
